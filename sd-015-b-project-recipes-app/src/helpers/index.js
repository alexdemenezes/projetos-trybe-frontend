...
export function favoriteRecipes(updateFavoriteRecipes, obj, type, favorite) {
  const { isFavorite, setIsFavorite } = favorite;
...
export function renderFavoriteStatus(favorite, updateFavoriteRecipes, obj, type) {
...
export function verifyIfIsFavorite(id, setIsFavorite) {
